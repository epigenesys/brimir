...
module AvatarHelper
  ...
  def gravatar_image_tag(email, options)
    # Based on: https://github.com/mdeering/gravatar_image_tag/blob/master/lib/gravatar_image_tag.rb#L64
    # and:      https://github.com/mdeering/gravatar_image_tag/pull/35

    gravatar_options = options.delete(:gravatar)
